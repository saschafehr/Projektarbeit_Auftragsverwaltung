...
namespace Projektarbeit_Auftragsverwaltung
{
    public class OrderContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 1, OrderPositionID = 1, ItemID = 41 ,Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 1, OrderPositionID = 2, ItemID = 56, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 2, OrderPositionID = 1, ItemID = 89, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 3, OrderPositionID = 1, ItemID = 47, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 4, OrderPositionID = 1, ItemID = 81, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 5, OrderPositionID = 1, ItemID = 22, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 5, OrderPositionID = 2, ItemID = 70, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 6, OrderPositionID = 1, ItemID = 61, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 7, OrderPositionID = 1, ItemID = 93, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 7, OrderPositionID = 2, ItemID = 15, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 8, OrderPositionID = 1, ItemID = 76, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 9, OrderPositionID = 1, ItemID = 53, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 9, OrderPositionID = 2, ItemID = 38, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 9, OrderPositionID = 3, ItemID = 21, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 10, OrderPositionID = 1, ItemID = 34, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 11, OrderPositionID = 1, ItemID = 12, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 11, OrderPositionID = 2, ItemID = 59, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 12, OrderPositionID = 1, ItemID = 96, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 13, OrderPositionID = 1, ItemID = 82, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 14, OrderPositionID = 1, ItemID = 19, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 14, OrderPositionID = 2, ItemID = 80, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 15, OrderPositionID = 1, ItemID = 60, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 16, OrderPositionID = 1, ItemID = 49, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 17, OrderPositionID = 1, ItemID = 87, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 17, OrderPositionID = 2, ItemID = 24, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 17, OrderPositionID = 3, ItemID = 68, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 18, OrderPositionID = 1, ItemID = 31, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 19, OrderPositionID = 1, ItemID = 69, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 19, OrderPositionID = 2, ItemID = 16, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 20, OrderPositionID = 1, ItemID = 74, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 20, OrderPositionID = 2, ItemID = 47, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 21, OrderPositionID = 1, ItemID = 84, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 22, OrderPositionID = 1, ItemID = 42, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 22, OrderPositionID = 2, ItemID = 12, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 23, OrderPositionID = 1, ItemID = 99, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 23, OrderPositionID = 2, ItemID = 51, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 24, OrderPositionID = 1, ItemID = 61, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 25, OrderPositionID = 1, ItemID = 92, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 26, OrderPositionID = 1, ItemID = 65, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 26, OrderPositionID = 2, ItemID = 20, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 26, OrderPositionID = 3, ItemID = 33, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 27, OrderPositionID = 1, ItemID = 79, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 28, OrderPositionID = 1, ItemID = 2, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 28, OrderPositionID = 2, ItemID = 72, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 29, OrderPositionID = 1, ItemID = 95, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 30, OrderPositionID = 1, ItemID = 29, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 31, OrderPositionID = 1, ItemID = 23, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 31, OrderPositionID = 2, ItemID = 85, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 32, OrderPositionID = 1, ItemID = 50, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 33, OrderPositionID = 1, ItemID = 70, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 34, OrderPositionID = 1, ItemID = 100, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 34, OrderPositionID = 2, ItemID = 40, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 35, OrderPositionID = 1, ItemID = 56, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 36, OrderPositionID = 1, ItemID = 20, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 36, OrderPositionID = 2, ItemID = 80, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 36, OrderPositionID = 3, ItemID = 10, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 37, OrderPositionID = 1, ItemID = 95, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 37, OrderPositionID = 2, ItemID = 4, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 38, OrderPositionID = 1, ItemID = 1, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 39, OrderPositionID = 1, ItemID = 23, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 39, OrderPositionID = 2, ItemID = 45, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 39, OrderPositionID = 3, ItemID = 67, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 40, OrderPositionID = 1, ItemID = 89, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 40, OrderPositionID = 2, ItemID = 101, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 40, OrderPositionID = 3, ItemID = 34, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 41, OrderPositionID = 1, ItemID = 17, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 41, OrderPositionID = 2, ItemID = 20, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 41, OrderPositionID = 3, ItemID = 23, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 41, OrderPositionID = 4, ItemID = 78, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 42, OrderPositionID = 1, ItemID = 50, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 42, OrderPositionID = 2, ItemID = 68, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 42, OrderPositionID = 3, ItemID = 30, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 42, OrderPositionID = 4, ItemID = 96, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 42, OrderPositionID = 5, ItemID = 12, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 43, OrderPositionID = 1, ItemID = 65, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 43, OrderPositionID = 2, ItemID = 33, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 43, OrderPositionID = 3, ItemID = 92, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 43, OrderPositionID = 4, ItemID = 56, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 43, OrderPositionID = 5, ItemID = 89, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 44, OrderPositionID = 1, ItemID = 21, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 44, OrderPositionID = 2, ItemID = 10, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 44, OrderPositionID = 3, ItemID = 103, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 44, OrderPositionID = 4, ItemID = 74, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 44, OrderPositionID = 5, ItemID = 77, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 45, OrderPositionID = 1, ItemID = 67, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 45, OrderPositionID = 2, ItemID = 29, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 45, OrderPositionID = 3, ItemID = 71, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 45, OrderPositionID = 4, ItemID = 86, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 45, OrderPositionID = 5, ItemID = 100, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 46, OrderPositionID = 1, ItemID = 47, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 46, OrderPositionID = 2, ItemID = 26, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 46, OrderPositionID = 3, ItemID = 70, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 46, OrderPositionID = 4, ItemID = 71, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 46, OrderPositionID = 5, ItemID = 94, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 47, OrderPositionID = 1, ItemID = 12, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 47, OrderPositionID = 2, ItemID = 19, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 47, OrderPositionID = 3, ItemID = 59, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 47, OrderPositionID = 4, ItemID = 76, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 47, OrderPositionID = 5, ItemID = 92, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 48, OrderPositionID = 1, ItemID = 87, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 48, OrderPositionID = 2, ItemID = 29, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 48, OrderPositionID = 3, ItemID = 46, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 48, OrderPositionID = 4, ItemID = 72, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 48, OrderPositionID = 5, ItemID = 101, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 49, OrderPositionID = 1, ItemID = 42, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 49, OrderPositionID = 2, ItemID = 70, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 49, OrderPositionID = 3, ItemID = 86, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 49, OrderPositionID = 4, ItemID = 104, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 49, OrderPositionID = 5, ItemID = 59, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 50, OrderPositionID = 1, ItemID = 53, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 50, OrderPositionID = 2, ItemID = 27, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 50, OrderPositionID = 3, ItemID = 59, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 50, OrderPositionID = 4, ItemID = 98, Amount = 2 });
            modelBuilder.Entity<OrderPosition>().HasData(new OrderPosition() { OrderID = 50, OrderPositionID = 5, ItemID = 16, Amount = 2 });
